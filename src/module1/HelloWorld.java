...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// TODO: Add code here that creates map2 Google.GoogleMapProvider()
		// Then you'll modify draw() below
		
		map2 = new UnfoldingMap(this, 430, 50, 350, 500, provider);
		
		// latitute=21.8306068 and logitutde=76.3348624
		map2.zoomAndPanTo(zoomLevel, new Location(21.8306068f, 76.3348624f));
